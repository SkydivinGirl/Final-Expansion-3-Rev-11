...
; firmware patch r022d by Dirk Vroomen, April 2014
...
STARTUPSCREEN
; dc.b CLRHOME, BLACK, CR, RVSON, "DISK UTILITY CARTRIDGE", CR, CR
  dc.b CLRHOME,FONT2,BLUE,RVSON,"*fINAL eXPANSION V3.2*", CR
  dc.b RVSON,                     "512/512kb sYSTEM R022D", CR, CR, CR
  dc.b BLACK,RVSON,"f1",RVSOFF," ram mANAGER", CR, CR
...
;  dc.b CR, CR
  dc.b BLACK,RVSON,"f7",RVSOFF," basic (wEDGE)", CR, CR
...
RAMSCREEN
  dc.b CLRHOME,FONT2,BLUE,RVSON, "  ram cONFIGURATION   ",CR,CR,CR
  dc.b BLACK,RVSON,"f1",RVSOFF," 3 kb (6655)", CR, CR
...
UTILSCREEN
  dc.b CLRHOME,FONT2,BLUE,RVSON, "    fe3 uTILITIES     ",CR,CR,CR
  dc.b BLACK,RVSON,"f1",RVSOFF," fLASH pROGRAM", CR, CR
...
THECREDITS
  dc.b CLRHOME, BLUE, "V3 06/2009", CR, CR
...
.bootloader ; execute boot-loader
  ...
  dc.b CLRHOME,BLUE,FONT2,RVSON,"---- bOOT lOADER  ----",CR,CR,0
...
DLOADER subroutine
  ...
  jsr INIT_CART                         ; Screen Colors
  jsr SPAR_PRINTSTRING
  dc.b CLRHOME,BLUE,FONT2,RVSON,"---- dISK lOADER  ----",CR,CR,0
...
CART_FLASHER
  jsr INIT_CART                         ; Screen Colors
  jsr SPAR_PRINTSTRING
  dc.b CLRHOME,BLUE,FONT2,RVSON,"---- cART fLASHER ----",CR,CR,0
...
CART_LOADER
  jsr INIT_CART                         ; Screen Colors
  jsr SPAR_PRINTSTRING
  dc.b CLRHOME,BLUE,FONT2,RVSON,"---- cART  lOADER ----",CR,CR,0
...
FLASH_INFO subroutine
  ;jsr CLROUT                           ;CLEAR SCREEN
  jsr SPAR_PRINTSTRING
  dc.b CLRHOME,FONT2,BLUE
  dc.b "## fLASH sTATUS ##",13,13,13
  dc.b BLACK,"eNTRIES: ",0
